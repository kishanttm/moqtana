@extends('layouts.app')
@section('title', __('Edit Service Order'))
@section('content')
<div class="d-flex align-items-center justify-content-between mb-3">
    <div>
        <h4 class="mb-0">{{ $cmsTranslations['edit_service_order']->name }}</h4>
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-0">
                ...
                <li class="breadcrumb-item active" aria-current="page">{{ $cmsTranslations['edit_service_order']->name }}</li>
            </ol>
        </nav>
    </div>
</div>
