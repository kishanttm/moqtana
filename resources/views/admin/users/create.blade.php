...
<div class="d-flex align-items-center justify-content-between mb-3">
    <div>
        <h4 class="mb-0">{{ $cmsTranslations['add_new_user']->name }}</h4>
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-0">
                ...
                <li class="breadcrumb-item active" aria-current="page">{{$cmsTranslations['add_new_user']->name}}</li>
            </ol>
        </nav>
    </div>
</div>
    ...
    <form action="{{ route('admin.users.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <ul class="list-unstyled">
                        <li class="row g-lg-3 g-2 mb-3">
                            ...
                            <div class="col-xl-7 col-lg-7 col-sm-8">
                                <input type="text" name="name" value="{{ old('name') }}" class="form-control" placeholder="Enter Name here">
                        ...
                        <li class="row g-lg-3 g-2 mb-3">
                            ...
                            <div class="col-xl-7 col-lg-7 col-sm-8">
                                <input type="email" name="email" value="{{ old('email') }}" class="form-control" placeholder="Enter here">
                            ...
                            <div class="col-xl-7 col-lg-7 col-sm-8">
                                <select id="role_single" name="role_single"  class="form-select" aria-label="Default select example">
                                    ...
                                    @foreach($roles as $id => $name)
                                        <option value="{{ $id }}" {{ old('role_single') == $id ? 'selected' : '' }}>
                                            {{ ucfirst($name) }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div id="valuationFields" class="d-none">
                            <li class="row g-lg-3 g-2 mb-3">
                                <div class="col-xl-3 col-lg-5 col-sm-4 d-flex align-items-center">
                                    <span>{{ $cmsTranslations['valuation_membership_number']->name }} <span class="text-danger">*</span>
                                </div>
                                <div class="col-xl-7 col-lg-7 col-sm-8">
                                    <input type="text" name="valuation_membership_number" value="{{ old('valuation_membership_number') }}" class="form-control">
                            ...
                            <li class="row g-lg-3 g-2 mb-3">
                                ...
                                <div class="col-xl-7 col-lg-7 col-sm-8">
                                    <input type="text" name="valuation_type" value="{{ old('valuation_type') }}" class="form-control">
                        ...
                        <li class="row g-lg-3 g-2 mb-3">
                            <div class="col-xl-3 col-lg-5 col-sm-4 d-flex align-items-center">
                                <span>{{ $cmsTranslations['password']->name }} <span class="text-danger">*</span>
                            </div>
                            <div class="col-xl-7 col-lg-7 col-sm-8">
                                <input type="password" class="form-control" name="password" value="{{ old('password') }}" placeholder="Enter here">
                                @error('password')<div class="text-danger">{{ $message }}</div>@enderror
                            </div>
                        </li>
                        <li class="row g-lg-3 g-2 mb-3">
                            <div class="col-xl-3 col-lg-5 col-sm-4 d-flex align-items-center">
                                <span>{{ $cmsTranslations['confirm_password']->name }} <span class="text-danger">*</span>
                            </div>
                            <div class="col-xl-7 col-lg-7 col-sm-8">
                                <input type="password" class="form-control" name="password_confirmation" placeholder="Enter here">
                            </div>
                        </li>
                        <li class="row g-lg-3 g-2 mb-3">
                            <div class="col-xl-3 col-lg-5 col-sm-4 d-flex align-items-center">
                                <span>{{ $cmsTranslations['profile_image']->name }} <span class="text-danger">*</span>
                            </div>
                            <div class="col-xl-7 col-lg-7 col-sm-8">
        ...
        <div class="col-12">
            <div class="page-action mt-2">
                <button class="btn btn-big btn-primary">{{ $cmsTranslations['save']->name }}</button>
