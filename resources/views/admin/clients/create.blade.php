...
<div class="d-flex align-items-center justify-content-between mb-3">
    <div>
        <h4 class="mb-0">{{ $cmsTranslations['add_new_client']->name }}</h4>
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-0">
                ...
                <li class="breadcrumb-item active" aria-current="page">{{ $cmsTranslations['add_new_client']->name }}</li>
            </ol>
        </nav>
    </div>
</div>
    ...
    <form action="{{ route('clients.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="col-12">
            <div class="card rounded-4">
                <div class="card-body">
                    <p class="mb-1 form-label">{{ $cmsTranslations['choose_client_type']->name }}</p>
                    <div class="client-type-wrapper border p-1 rounded d-inline-flex mb-4">
                        <label class="client-type-option">
                            ...
                            <span>{{ $cmsTranslations['individual']->name }}</span>
                        </label>
    
                        <label class="client-type-option">
                            <input type="radio" name="client_type" value="business"
                                {{ old('client_type') == 'business' ? 'checked' : '' }}>
                            <span>{{ $cmsTranslations['business']->name }}</span>
                        </label>
                    </div>
                    <div id="individualFields">
                        <div class="row g-lg-4 g-3">
                            <div class="col-xl-4 col-lg-6">
                                ...
                                <input type="text" class="form-control" name="individual_name" value="{{ old('individual_name') }}" placeholder="Enter here">
                            ...
                            <div class="col-xl-4 col-lg-6">
                                ...
                                <input type="text" class="form-control" name="national_id" value="{{ old('national_id') }}" placeholder="Enter here">
                            ...
                            <div class="col-xl-4 col-lg-6">
                                ...
                                <input type="number" class="form-control" name="mobile_number" value="{{ old('mobile_number') }}" placeholder="Enter here">
                            ...
                            <div class="col-xl-6 col-lg-6">
                                ...
                                <input type="text" class="form-control"  name="address" value="{{ old('address') }}" placeholder="Enter here">
                                @error('address')<div class="text-danger">{{ $message }}</div>@enderror
                            </div>
                            <div class="col-xl-6 col-lg-6">
                                <label class="form-label">{{ $cmsTranslations['client_email_address']->name }} <span class="text-danger">*</span></label>
                                <input type="email" class="form-control" name="individual_email" value="{{ old('individual_email') }}" placeholder="Enter here">
                    ...
                    <div id="businessFields" class="d-none">
                        <div class="row g-lg-4 g-3">
                            <div class="col-lg-4 col-md-12">
                                ...
                                <input type="text" class="form-control" name="company_name" value="{{ old('company_name') }}" placeholder="Enter here">
                            ...
                            <div class="col-lg-4 col-md-6">
                                ...
                                <input type="text" class="form-control" name="unified_number" value="{{ old('unified_number') }}" placeholder="Enter here">
                            ...
                            <div class="col-lg-4 col-md-6">
                                ...
                                <input type="number" class="form-control" name="vat_number" value="{{ old('vat_number') }}" placeholder="Enter here">
                                @error('vat_number')<div class="text-danger">{{ $message }}</div>@enderror
                            </div>
                            <div class="col-12">
                                <label class="form-label">{{ $cmsTranslations['address']->name }}</label>
                                <input type="text" class="form-control" name="address_business" value="{{ old('address_business') }}" placeholder="Enter here">
                            ...
                            <div class="col-xl-6 col-lg-6">
                                ...
                                <input type="text" class="form-control" name="ceo_name" value="{{ old('ceo_name') }}" placeholder="Enter here">
                            ...
                            <div class="col-xl-6 col-lg-6">
                                ...
                                <input type="email" class="form-control" name="ceo_email" value="{{ old('ceo_email') }}" placeholder="Enter here">
                            ...
                            <div class="col-lg-4 col-md-12">
                                ...
                                <input type="text" class="form-control" name="representative_name" value="{{ old('representative_name') }}" placeholder="Enter here">
                            ...
                            <div class="col-lg-4 col-md-6">
                                ...
                                <input type="number" class="form-control" name="representative_mobile" value="{{ old('representative_mobile') }}" placeholder="Enter here">
                            ...
                            <div class="col-lg-4 col-md-6">
                                ...
                                <input type="email" class="form-control" name="representative_email" value="{{ old('representative_email') }}" placeholder="Enter here">
                            ...
                            <div class="col-lg-4 col-md-12">
                                ...
                                <input type="text" class="form-control" name="accountant_name" value="{{ old('accountant_name') }}" placeholder="Enter here">
                            ...
                            <div class="col-lg-4 col-md-6">
                                ...
                                <input type="number" class="form-control" name="accountant_mobile" value="{{ old('accountant_mobile') }}" placeholder="Enter here">
                            ...
                            <div class="col-lg-4 col-md-6">
                                ...
                                <input type="email" class="form-control" name="accountant_email" value="{{ old('accountant_email') }}" placeholder="Enter here">
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        // Set initial state on page load (Laravel old value support)
